                ...
                <div class="container-lg">
                    ...
                    <div class="row gap-row">
                        <div class="col-lg-4 col-md-6 with-you-box">
                            ...
                            <div class="with-img" style={{ backgroundImage: "url(https://ecis.in/sayahomes-react/assets/images/Assurance-of-Delivery.jpg)" }}></div>
                        </div>
                        <div class="col-lg-4 col-md-6 with-you-box">
                            <div class="inner">
                                <span class="line-plus"></span>
                            ...
                            <div class="with-img" style={{ backgroundImage: "url(https://ecis.in/sayahomes-react/assets/images/High-Quality.jpg)" }}></div>
                        </div>
                        <div class="col-lg-4 col-md-6 with-you-box">
                            <div class="inner">
                                <span class="line-plus"></span>
                            ...
                            <div class="with-img" style={{ backgroundImage: "url(https://ecis.in/sayahomes-react/assets/images/Eco-friendly.jpg)" }}></div>
                        </div>
                        <div class="col-lg-4 col-md-6 with-you-box">
                            <div class="inner">
                                <span class="line-plus"></span>
                            ...
                            <div class="with-img" style={{ backgroundImage: "url(https://ecis.in/sayahomes-react/assets/images/Transparent-Timely.jpg)" }}></div>
                        </div>
                        <div class="col-lg-8 col-md-6 with-you-box">
                            ...
                            <div class="with-img" style={{ backgroundImage: "url(https://ecis.in/sayahomes-react/assets/images/Handover.jpg)" }}></div>
                        </div>
                    </div>
                </div>
            </div>
